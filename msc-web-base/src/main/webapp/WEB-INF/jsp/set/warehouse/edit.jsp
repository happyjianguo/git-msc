		...
		<table class="table-bordered">
		   <tr>
		   		...
		   		<th>
					...
					<input type="text" name="code" class="easyui-textbox" data-options="required:true" readonly />
				</th>
		   </tr>
		   <tr>
		   		<th>名称:</th>
...
$(function(){
    ...
    $("#form1").form({
		url :" <c:out value='${pageContext.request.contextPath }'/>/set/warehouse/edit.htmlx",
		onSubmit : function() {
