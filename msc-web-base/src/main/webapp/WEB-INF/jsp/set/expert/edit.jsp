		...
		<table class="table-bordered">
		   <tr>
		      ...
		      <tr>
		   		<th>手机:</th>
		   		<th>
					<input type="text" name="mobile" class="easyui-validatebox easyui-textbox-20" data-options="validType:'mobile'"  style="width:200px">
				</th>
				<th>固定电话:</th>
		   		<th>
					<input type="text" name="tel" class="easyui-validatebox easyui-textbox-20" data-options="validType:'phone'"  style="width:200px">
				</th>
		   	</tr>
		    <tr >
		   		<th>所属机构:</th>
