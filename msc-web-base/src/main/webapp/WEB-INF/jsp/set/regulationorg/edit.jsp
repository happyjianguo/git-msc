...
<div>
	<form id="form1" name="form1"  method="post">
		...
		<tr>
		   		<th>单位编码:</th>
		   		<th>
					<input type="text" name="code" class="easyui-validatebox easyui-textbox" data-options="required:true" style="width:200px" readonly/>
...
$(function(){
	...
	$("#form1").form({
		url :" <c:out value='${pageContext.request.contextPath }'/>/set/regulationorg/edit.htmlx",
		onSubmit : function() {	
