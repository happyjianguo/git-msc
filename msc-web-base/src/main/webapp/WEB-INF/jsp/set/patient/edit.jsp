	...
	<form id="form1" name="form1"  method="post">
		<table class="table-bordered">
		 	<tr>
				<th>ID：</th>
		   		<th>
		   			<input type="text" name="id" class="easyui-validatebox easyui-textbox" data-options="editable:false,required:true,validType:'maxLength[50]'">
		   		</th>
		   </tr>
		   <tr>
				<th>姓名：</th>
...
$(function(){
	...
	$("#form1").form({
		url :" <c:out value='${pageContext.request.contextPath }'/>/set/patient/edit.htmlx",
		onSubmit : function() {
