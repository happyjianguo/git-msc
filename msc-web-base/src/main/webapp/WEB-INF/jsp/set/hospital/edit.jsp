	...
	<form id="form1" name="form1"  method="post">
		<table class="table-bordered">
		   <tr>
		   		<th>单位编码:</th>
		   		<th>
					<input type="text" name="code" class="easyui-validatebox easyui-textbox-20" data-options="required:true" style="width:200px" readonly/>
		   ...
		   <tr>
		    ...
		    <tr> 
		   	...
		   	<tr>
		   		<th>注册资金（万元）:</th>
		   		<th>
					<input type="text" name="capital" class="easyui-textbox" style="width:200px"/>
				</th>
				<th>总资产（万元）:</th>
		   		<th>
		   ...
		   <tr> 
		   	...
		   	<tr>
				...
				<th>接口编号:</th>
		   		<th>
		   			<input type="text" name="iocode" class="easyui-textbox" style="width:200px"  data-options="required:true"/>
		   		</th>
		   </tr>
		   <tr>
		   		<th>卫生许可证号:</th>
		   ...
		   <tr>
		   		<th>营业执照:</th>
		   		<th>
					<input type="text" name="licenseNO" class="easyui-textbox-20" style="width:200px"/>
				</th>
				<th>营业执照有效日期:</th>
		   		<th>
...
$(function(){
	...
	$("#form1").form({
		url :" <c:out value='${pageContext.request.contextPath }'/>/set/hospital/edit.htmlx",
		onSubmit : function() {	
