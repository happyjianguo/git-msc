...
<div class="single-dg">
	<shiro:hasPermission name="dm:drugType:add">
...
function addOpen() {
	top.$.modalDialog({
		...
		width : 600,
		height : 400,
		href : " <c:out value='${pageContext.request.contextPath }'/>/dm/drugType/add.htmlx",
		onLoad:function(){
...
function editOpen() {
	...
	top.$.modalDialog({
		title : "修改 id:"+selrow.id,
		width : 600,
		height : 400,
		href : " <c:out value='${pageContext.request.contextPath }'/>/dm/drugType/edit.htmlx",
		queryParams:{
		},
		onLoad:function(){
			if(selrow){
...
function delAjax(id){
	$.ajax({
				url:" <c:out value='${pageContext.request.contextPath }'/>/dm/drugType/del.htmlx",
				data:"id="+id,
				dataType:"json",
				type:"POST",
				cache:false,
