	...
	<form id="form1" name="form1"  method="post">
		<table class="table-bordered">
			<tr>
		   		<th>编码:</th>
		   		<th>
					<input type="text" name="code" class="easyui-validatebox  easyui-textbox" data-options="readonly:true" style="width:200px" >
				</th>
		   </tr>
		   <tr>
		   		<th>名称:</th>
...
$(function(){
	...
	$("#form1").form({
		url :" <c:out value='${pageContext.request.contextPath }'/>/dm/sickness/edit.htmlx",
		onSubmit : function() {
