		...
		<div style="margin-bottom: 50px;">
			<div class="head" style="margin-top:0px">
				...
				<div style="margin-left:60px;margin-bottom: 10px;">
					<span style="margin-left:30px;font-size:35px; line-height: 60px;"><%=CommonProperties.FIRSTCLASSNAME %></span>
				</div>
				<div style="margin-left:90px;margin-bottom: 0px;margin-top: 24px;">
					<span style="margin-left:60px;font-size:25px; line-height: 30px;"><%=CommonProperties.SYSNAME %>
				<span style="font-size:18px;margin-left:120px;color:#999">欢迎登录</span>
				</span>
				</div>
			</div>
		</div>
...
<div id="content" class="content" >
	<div id='loginwin' class="loginwin">
	  <form name="form1" id="form1" action="${pageContext.request.contextPath }/sys/login.htmlx" method="post">
			...
			<input type="hidden" value="13"  name="loginType" />
		</form>
	  </div>
  </div>
...
<%
	...
	<%}else{%>
		<div id="backgrounddiv" class="backgrounddiv">
			<img id="bgimg1" width="100%"  height="90%" style="margin-top: 130px;" src="<c:out value='${pageContext.request.contextPath }'/>/resources/images/loginbg2.jpg" ></img>
			<div id="footer1" class="footer" style="color:#999;text-align:center;font-size:12px;line-height: 30px;"></div>
		</div>
	<%}
%>
