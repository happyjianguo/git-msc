	...
	<form id="form1" name="form1"  method="post">
		<table class="table-bordered">
		   <tr>
		   		<th>年月:</th>
		   		<th>
					<input type="text" id="month" name="month" class="easyui-textbox" readonly="readonly" data-options="required:true"/>
				</th>	
...
$(function(){    $("input").textbox({validType:'length[0,50]'});
	...
	$("#form1").form({
		url :" <c:out value='${pageContext.request.contextPath }'/>/hospital/baseDrugProvide/edit.htmlx",
		onSubmit : function() {
