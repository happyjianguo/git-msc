...
$(function() {
	...
	function initChart(data, showType,absType,countType,zoneName) {
		$("#chart").empty();
		var axis = [];
		var newData=[];
		$(data).each(function(i) {
			...
			var value ;
				if(absType.length==0){
					value = data[i]['ABSDRUGSUM']/data[i]['DRUGSUM']
				}else if(absType==0){
					value = data[i]['ABSTYPE1SUM']/data[i]['DRUGSUM']
				}else if(absType==1){
					value = data[i]['ABSTYPE2SUM']/data[i]['DRUGSUM']
				}else{
					value = data[i]['ABSTYPE3SUM']/data[i]['DRUGSUM']
				}
	...
	initChart(top.$.modalDialog.data[0],top.$.modalDialog.data[1],top.$.modalDialog.data[2],top.$.modalDialog.data[3],top.$.modalDialog.data[4]);
});
</script>
