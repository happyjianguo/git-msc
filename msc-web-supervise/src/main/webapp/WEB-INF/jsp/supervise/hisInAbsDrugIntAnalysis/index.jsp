...
<body class="easyui-layout">
	<div data-options="region:'center',title:''">
		...
		<div id="toolbar" class="search-bar" >
				<shiro:hasPermission name="supervise:hisInAbsDrugIntAnalysis:export">
...
<script>
	...
	$(function() {
		...
		$('#dg').datagrid({
			...
			pagination : true,
			url : "<c:out value='${pageContext.request.contextPath }'/>/supervise/hisInAbsDrugIntAnalysis/page.htmlx",
	...
	function getColumns(queryType) {
		var columns = [ {
			...
			field : 'AVGDDDSUM',
			title : '<span title="DDD累计值  / 出院病人总住院天数" class="tip">住院抗菌药物使用强度(%)</span>',
			width : 120,
			align : 'center'
		} ];
	...
	function showChart() {
		...
		top.$.modalDialog({
			...
			width : 800,
			height : 460,
			href : "<c:out value='${pageContext.request.contextPath }'/>/supervise/hisInAbsDrugIntAnalysis/chart.htmlx"
		});
	}
	
	function exportexcel(){
		var url = "<c:out value='${pageContext.request.contextPath }'/>/supervise/hisInAbsDrugIntAnalysis/export.htmlx?";
		for (var k in window.queryParams) {
