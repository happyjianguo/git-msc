	...
	<form id="form1" name="form1"  method="post">
		...
		<tr>
		   ...
		   <tr>
				...
				<th>疾病名称：</th>
		   		<th>
		   			<input id="diseaseCode" name="diseaseCode" />
		   		</th>
		   </tr>
		<%} else {%>
			<tr>
...
$(function(){
	...
	//下拉
	$('#diseaseCode').combogrid({
		idField:'DISEASECODE',    
		textField:'DISEASENAME',
		url: ' <c:out value='${pageContext.request.contextPath }'/>/supervise/diseaseAnalysis/disease.htmlx',
		pagination:false,
	    columns: [[
	        {field:'DISEASECODE',title:'疾病编码',width:75},
	        {field:'DISEASENAME',title:'疾病名称',width:100}
	    ]],
	    width:100,
	    panelWidth:200,
		delay:800,
		...
		keyHandler: { 
	        enter: function(e) {
                $('#diseaseCode').combogrid('grid').datagrid("reload",{"query['t#diseaseName_S_LK']":$('#diseaseCode').combogrid("getText")});
                $('#diseaseCode').combogrid("setValue", $('#diseaseCode').combogrid("getText"));
	        }
        }
	});
	$.ajax({
