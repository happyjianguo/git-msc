...
<ul >
               <li onclick="javascript:window.location.href='<c:out value='${pageContext.request.contextPath}'/>/login.jsp'">
                    <div class="theme"   onmouseenter="m_over(this)" onmouseleave="m_out(this)">
                        ...
                        <img width=100% height=280px src="<c:out value='${pageContext.request.contextPath }'/>/resources/images/homeyy.jpg" >
                 ...
                 <li onclick="javascript:window.location.href='<c:out value='${pageContext.request.contextPath}'/>/login.jsp'">
                    <div class="theme"  onmouseenter="m_over(this);" onmouseleave="m_out(this);">
                        <img width=100% height=280px src="<c:out value='${pageContext.request.contextPath }'/>/resources/images/homejd.jpg" >
                        <h2 style="text-align:center;color:#333">
                            监管机构
                        </h2>
                    </div>
                ...
                <li onclick="javascript:window.location.href='<c:out value='${pageContext.request.contextPath}'/>/login.jsp'">
                    <div class="theme" onmouseenter="m_over(this)" onmouseleave="m_out(this)">
                        <img width=100% height=280px src="<c:out value='${pageContext.request.contextPath }'/>/resources/images/homegpo.jpg" >
                        <h2 style="text-align:center;color:#333">
                            供应商
                        </h2>
                    </div>
