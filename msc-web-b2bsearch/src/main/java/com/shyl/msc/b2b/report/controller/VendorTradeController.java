 ...
 */
@Controller
@RequestMapping("/b2b/report/vendortrade")
public class VendorTradeController extends BaseController {
	...
	@RequestMapping("list")
	public String list(){
		return "b2b/report/vendortrade/list";
	}
	...
	public String chart(Long vendorId, String year, String vendorName,Model model){
		...
		return "b2b/report/vendortrade/chart";
	}
