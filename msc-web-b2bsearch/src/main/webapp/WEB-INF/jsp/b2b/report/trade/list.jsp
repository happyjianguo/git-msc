...
$(function(){
	...
	$('#dg').datagrid({
		...
		//pagination:true,
		url:" <c:out value='${pageContext.request.contextPath }'/>/b2b/report/trade/list.htmlx",
		queryParams:{
...
function openChart() {
	top.$.modalDialog({
		...
		width : 800,
		height : 500,
		href : " <c:out value='${pageContext.request.contextPath }'/>/b2b/report/trade/chart.htmlx",
		queryParams:{
			year: $('#year').combobox('getValue')
		},
		buttons : [ {
