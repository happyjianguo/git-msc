...
<body class="easyui-layout" >
	<div class="search-bar" >
	 	供应商名称: 
	 	<input id="vendorName" type="text" class="easyui-textbox" style="width:150px">
                           年份: 
	 	<input id="year"/>
...
$(function(){
	...
	$('#dg').datagrid({
		...
		pagination:true,
		url:" <c:out value='${pageContext.request.contextPath }'/>/b2b/report/gpotrade/page.htmlx",
		queryParams:{
...
function openChart() {
	...
	top.$.modalDialog({
		...
		width : 800,
		height : 500,
		href : " <c:out value='${pageContext.request.contextPath }'/>/b2b/report/gpotrade/chart.htmlx",
		queryParams:{
			year: $('#year').combobox('getValue'),
...
function query(){
	$('#dg').datagrid('load',{
		"name": $('#vendorName').textbox('getValue'),
		"year": $('#year').combobox('getValue')
	});
}
