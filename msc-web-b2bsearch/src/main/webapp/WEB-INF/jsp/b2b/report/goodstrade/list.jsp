...
<div  data-options="region:'north',title:'',collapsible:false"  class="my-north" style="height:300px;" >
	<div class="search-bar">
		...
		<%--<shiro:hasPermission name="admin:goodstrade:doCount">
...
function dosearch(){
	...
	$('#dg').datagrid({
		url:" <c:out value='${pageContext.request.contextPath }'/>/b2b/report/goodstrade/page.htmlx",
		queryParams:{
...
function todg2(){
	...
	var monthE = $("#monthE").combo('getValue');
	$('#dg2').datagrid({  
	    url:" <c:out value='${pageContext.request.contextPath }'/>/b2b/report/goodstrade/mxpage.htmlx",  
	    queryParams:{
	        "id":selrow.ID,
	        "dateS":yearS+monthS,
	        "dateE":yearE+monthE
...
function doCount() {
    $.ajax({
        url:" <c:out value='${pageContext.request.contextPath }'/>/b2b/report/goodstrade/doCount.htmlx",
        data:{"projectCode":"01"},
        dataType:"json",
        type:"POST",
        cache:false,
