	...
	<form id="form1" name="form1"  method="post">
		...
		<table class="table-bordered">
		   <tr>
				<th>药品目录编码：</th>
		   		<th>
		   			<input type="hidden"  id="drugId" name="drug.id"/>
		   			<input type="text" id="genericName" name="genericName" class="easyui-textbox" readonly="readonly"/>
		   		</th>
		   		<th>药品编码：</th>
		   		<th>
		   ...
		   <tr>
				...
				<th>生产企业：</th>
		   		<th>
		   			<input type="hidden" id="producerId" name="company.id"/>
		   			<input type="text" id="producerName" name="producerName" class="easyui-textbox"/>
		   		</th>
		   </tr>
		   <tr>	   	
		   		<th>药品规格：</th>
		    ...
		    <tr>	   	
		   		<th>剂量：</th>
		   		<th>
		   			<input type="text" name="dose" id="dose" class="easyui-validatebox  easyui-textbox" data-options="required:true"   />
		   		</th>	
		   		<th>剂量单位：</th>
		   		<th>
		   ...
		   <tr>
				<th>国药准字：</th>
		   		<th>
		   			<input type="text" name="nationalAuthorizeNo" class="easyui-validatebox  easyui-textbox" />
		   		</th>
		   		<th>国药准字有效期：</th>
		   		<th>
...
$(function(){
	...
	$('#producerName').combogrid({
		...
		keyHandler: {
            query: function(q) {
                //动态搜索
                $('#producerName').combogrid('grid').datagrid("reload",{"query['t#fullName_S_LK']":q});
