...
@Controller
@RequestMapping("/count/hospitalC1")
public class HospitalC1Controller extends BaseController {
	...
	public String chart1(String hospitalCode,Model model,@CurrentUser User user){
		...
		return "count/hospitalC1/chart1";
	}
	...
	public String chart2(String month,Model model,@CurrentUser User user){
		...
		return "count/hospitalC1/chart2";
	}
