 ...
 */
@Controller
@RequestMapping("/count/trade")
public class TradeCController extends BaseController {
	...
	public Message Chart(String year, @CurrentUser User user){
		...
		try {
			...
			List<Map<String, Object>> list = productCService.reportCTrade(user.getProjectCode(), year);
