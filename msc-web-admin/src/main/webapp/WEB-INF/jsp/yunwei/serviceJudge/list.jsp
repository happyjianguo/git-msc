...
$(function(){
	...
	$('#dg').datagrid({
		...
		url:"<c:out value='${pageContext.request.contextPath }'/>/yunwei/serviceJudge/page.htmlx",
		filterDelay:100,
		columns:[[
	...
	function addPara() {
		...
		top.$.modalDialog({
			...
			width : 600,
			height : 400,
			href : "<c:out value='${pageContext.request.contextPath }'/>/yunwei/serviceJudge/para.htmlx",
			onLoad:function(){
				if(selobj){
