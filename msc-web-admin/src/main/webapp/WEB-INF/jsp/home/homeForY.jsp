...
<body>
    ...
    <script type="text/javascript">
        var panels = [
                      ...
                      {id:'p2',title:'统计',height:200,collapsible:true,iconCls:'icon-defect_define',href:'<c:out value='${pageContext.request.contextPath }'/>/home/monitorTotal.htmlx'},
                      {id:'p3',title:'消息',height:200,collapsible:true,iconCls:'icon-process',href:'<c:out value='${pageContext.request.contextPath }'/>/home/msg.htmlx'}/* ,
