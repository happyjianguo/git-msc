...
<body class="easyui-layout">
	...
	<img src="<c:out value='${base }'/>/resources/images/logo2015.png" style="margin-left:30px;margin-top:5px;width:50px;float:left; border-radius:4px"></img>
	
		<!-- <span class="sys-name">上海药联药品管理系统 -->
