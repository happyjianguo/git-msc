	...
	<form id="form1" name="form1"  method="post">
		<table class="table-bordered">
		   <tr>
		   		<th>资源名称:</th>
		   		<th>
					<input type="text" name="name" id="name" value="${resource.name }" class="easyui-validatebox  easyui-textbox" data-options="required:true"  >
				</th>
		   </tr>
		   <tr>
				<th>资源路径：</th>
		   		<th>
		   			<input type="text" name="url" value="${resource.url }" class="easyui-validatebox  easyui-textbox"  >
		   		</th>
		   </tr>
		   <tr>
		   		<th>资源图标：</th>
		...
		<div id="iconlist" style="padding:10px;"></div>
