...
import com.shyl.jmeter.client.PurchaseClosedRequestClient;
 ...
 *
 */
public class PurchaseClosedRequestFedback extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			...
			String result = new PurchaseClosedRequestClient().fedback(iocode, dataType, data);
	...
	public static void main(String[] args) {
		...
		PurchaseClosedRequestFedback test = new PurchaseClosedRequestFedback();
		test.setupTest(arg0);
		test.runTest(arg0);
