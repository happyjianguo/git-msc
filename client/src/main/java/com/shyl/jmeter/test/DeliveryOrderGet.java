 ...
 *
 */
public class DeliveryOrderGet extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			...
			String result = deliveryOrderClient.get(iocode, dataType, data, yybm);
	...
	public static void main(String[] args) {
		...
		DeliveryOrderGet test = new DeliveryOrderGet();
		test.setupTest(arg0);
		test.runTest(arg0);
