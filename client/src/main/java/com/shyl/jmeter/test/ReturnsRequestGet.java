...
public class ReturnsRequestGet extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			String result = new ReturnsRequestClient().get(iocode,dataType, data);
	...
	public static void main(String[] args) {
		...
		ReturnsRequestGet test = new ReturnsRequestGet();
		test.setupTest(arg0);
		test.runTest(arg0);
