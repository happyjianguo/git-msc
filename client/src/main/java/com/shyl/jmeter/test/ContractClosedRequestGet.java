...
import com.shyl.jmeter.client.ContractClosedRequestClient;
 ...
 *
 */
public class ContractClosedRequestGet extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			...
			String result = new ContractClosedRequestClient().get(iocode, dataType, data);
	...
	public static void main(String[] args) {
		...
		ContractClosedRequestGet test = new ContractClosedRequestGet();
		test.setupTest(arg0);
		test.runTest(arg0);
