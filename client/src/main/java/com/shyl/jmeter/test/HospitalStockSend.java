...
import com.shyl.jmeter.client.HospitalStockClient;

public class HospitalStockSend extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			String result = new HospitalStockClient().send(iocode,dataType, data,yybm);
	...
	public static void main(String[] args) {
		...
		params.addArgument("iocode", "59296069");// 设置参数，并赋予默认值
		...
		HospitalStockSend test = new HospitalStockSend();
		test.setupTest(arg0);
		test.runTest(arg0);
