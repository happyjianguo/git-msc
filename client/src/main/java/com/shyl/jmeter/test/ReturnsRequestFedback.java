...
import com.shyl.jmeter.client.ReturnsRequestClient;

public class ReturnsRequestFedback extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			String result = new ReturnsRequestClient().fedback(iocode,dataType, data);
	...
	public static void main(String[] args) {
		...
		ReturnsRequestFedback test = new ReturnsRequestFedback();
		test.setupTest(arg0);
		test.runTest(arg0);
