...
import com.shyl.jmeter.client.InvoiceClient;

public class InvoiceSend extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			String result = new InvoiceClient().send(iocode,dataType, data);
	...
	public static void main(String[] args) {
		...
		InvoiceSend test = new InvoiceSend();
		test.setupTest(arg0);
		test.runTest(arg0);
