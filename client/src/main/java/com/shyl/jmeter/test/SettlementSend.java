...
import com.shyl.jmeter.client.SettlementClient;

public class SettlementSend extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			String result = new SettlementClient().send(iocode,dataType, data);
	...
	public static void main(String[] args) {
		...
		SettlementSend test = new SettlementSend();
		test.setupTest(arg0);
		test.runTest(arg0);
