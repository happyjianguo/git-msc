...
import com.shyl.jmeter.client.PaymentClient;

public class PaymentSend extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			String result = new PaymentClient().send(iocode,dataType, data);
	...
	public static void main(String[] args) {
		...
		PaymentSend test = new PaymentSend();
		test.setupTest(arg0);
		test.runTest(arg0);
