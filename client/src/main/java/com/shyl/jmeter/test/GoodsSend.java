...
import com.shyl.jmeter.client.GoodsClient;

public class GoodsSend extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			String result = new GoodsClient().send(iocode,dataType, data);
