...
import com.shyl.jmeter.client.ProductPriceClient;

public class ProductPriceSend extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			String result = new ProductPriceClient().send(iocode,dataType, data);
	...
	public static void main(String[] args) {
		...
		ProductPriceSend test = new ProductPriceSend();
		test.setupTest(arg0);
		test.runTest(arg0);
