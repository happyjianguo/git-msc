 ...
 *
 */
public class PurchaseClosedRequestGet extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			...
			String result = new PurchaseClosedRequestClient().get(iocode, dataType, data);
	...
	public static void main(String[] args) {
		...
		PurchaseClosedRequestGet test = new PurchaseClosedRequestGet();
		test.setupTest(arg0);
		test.runTest(arg0);
