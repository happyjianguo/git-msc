...
public class ReturnsRequestSend extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			String result = new ReturnsRequestClient().send(iocode,dataType, data);
	...
	public static void main(String[] args) {
		...
		ReturnsRequestSend test = new ReturnsRequestSend();
		test.setupTest(arg0);
		test.runTest(arg0);
