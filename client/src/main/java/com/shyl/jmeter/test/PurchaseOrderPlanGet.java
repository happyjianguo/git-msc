 ...
 *
 */
public class PurchaseOrderPlanGet extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			...
			String result = new PurchaseOrderPlanClient().get(iocode, dataType, data);
	...
	public static void main(String[] args) {
		...
		PurchaseOrderPlanGet test = new PurchaseOrderPlanGet();
		test.setupTest(arg0);
		test.runTest(arg0);
