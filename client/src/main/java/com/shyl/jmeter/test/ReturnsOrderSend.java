...
import com.shyl.jmeter.client.ReturnsOrderClient;

public class ReturnsOrderSend extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			String result = new ReturnsOrderClient().send(iocode,dataType, data);
	...
	public static void main(String[] args) {
		...
		ReturnsOrderSend test = new ReturnsOrderSend();
		test.setupTest(arg0);
		test.runTest(arg0);
