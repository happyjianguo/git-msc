...
public class PurchaseOrderPlanSend extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			String result = new PurchaseOrderPlanClient().send(iocode,dataType, data, yybm);
	...
	public static void main(String[] args) {
		...
		PurchaseOrderPlanSend test = new PurchaseOrderPlanSend();
		test.setupTest(arg0);
		test.runTest(arg0);
