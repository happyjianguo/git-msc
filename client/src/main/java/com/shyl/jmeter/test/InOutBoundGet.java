...
public class InOutBoundGet extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			String result = new InOutBoundClient().get(iocode,dataType, data);
	...
	public static void main(String[] args) {
		...
		InOutBoundGet test = new InOutBoundGet();
		test.setupTest(arg0);
		test.runTest(arg0);
