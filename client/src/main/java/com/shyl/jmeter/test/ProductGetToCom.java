...
import com.shyl.jmeter.client.ProductClient;
 ...
 *
 */
public class ProductGetToCom extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			...
			String result = new ProductClient().GetToCom(iocode, dataType, data);
	...
	public static void main(String[] args) {
		...
		ProductGetToCom test = new ProductGetToCom();
		test.setupTest(arg0);
		test.runTest(arg0);
