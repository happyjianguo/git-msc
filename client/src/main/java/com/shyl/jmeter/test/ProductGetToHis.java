 ...
 *
 */
public class ProductGetToHis extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			...
			String result = productClient.getToHis(iocode, dataType, data);
	...
	public static void main(String[] args) {
		...
		ProductGetToHis test = new ProductGetToHis();
		test.setupTest(arg0);
		test.runTest(arg0);
