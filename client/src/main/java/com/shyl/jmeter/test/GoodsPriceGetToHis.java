...
import com.shyl.jmeter.client.GoosPriceClient;
 ...
 *
 */
public class GoodsPriceGetToHis extends BaseJmeterClient implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
		...
		try {
			...
			String result = new GoosPriceClient().getToHis(iocode, dataType, data);
	...
	public static void main(String[] args) {
		...
		GoodsPriceGetToHis test = new GoodsPriceGetToHis();
		test.setupTest(arg0);
		test.runTest(arg0);
