...
public class PurchaseClosedRequestClient {
	public String send(String iocode,String dataType, String data) throws RemoteException, ServiceException{
		...
		String result = ServiceUtil.callWebService(Constants.wsdlUrl_purchaseClosedRequest, Constants.nameSpaceUri, "send", sendData);
		return result;
	}
	...
	public String get(String iocode,String dataType, String data) throws RemoteException, ServiceException{
		...
		String result = ServiceUtil.callWebService(Constants.wsdlUrl_purchaseClosedRequest, Constants.nameSpaceUri, "get", sendData);
		return result;
	}
	...
	public String fedback(String iocode,String dataType, String data) throws RemoteException, ServiceException{
		...
		String result = ServiceUtil.callWebService(Constants.wsdlUrl_purchaseClosedRequest, Constants.nameSpaceUri, "fedback", sendData);
		return result;
	}
}
