...
public class PrescriptGetByPlanCode {
	public static void main(String[] args){
		try {
			...
			call.setOperationName(new QName(nameSpaceUri, "getByPlanCode"));
			...
			String sign = "";
			String data = "";
			String iocode = "124124131";
			JSONObject js = new JSONObject();
			
			js.put("cgjhdmxbh", "C2016081100000001");
