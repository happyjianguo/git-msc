...
<head>
	...
	<script>
	   var webName = "<c:out value='${base }'/>";
	   var CAName = "<%=CommonProperties.CANAME_JS %>";
   </script>
  	<script  type="text/javascript" src="<c:out value='${base }'/>/resources/js/ca/ComCA.js"></script>
  	<style type="text/css">
  		.sys-name{
...
<body class="easyui-layout">
	...
	<div data-options="region:'south',border:false" style="height:28px;" class="footer">
	 ...
	 -->
	<!-- 中间 -->
	<div data-options="region:'center',href:'<c:out value='${base }'/>/home/center.htmlx'">
			</div>
...
function updateOpen() {
	...
	top.$.modalDialog({
		...
		width : 400,
		height : 250,
		href : "<c:out value='${base }'/>/sys/user/updatePsw.htmlx",
		onLoad:function(){
...
$(function(){
	$('#leftTree').tree({
		...
		onClick: function(node){
			var url = node.url;
			if(url!=null&&url != ""){
				addTab(node.text,url,node.icon, true);
			}
		},
