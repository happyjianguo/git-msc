...
<body>
    ...
    <script type="text/javascript">
        var panels = [
                      {id:'p1',title:'公告',height:200,collapsible:true,iconCls:'icon-defect_define',tools:'#tt',href:' <c:out value='${pageContext.request.contextPath }'/>/home/notice.htmlx'},
                      {id:'p2',title:'统计',height:200,collapsible:true,iconCls:'icon-defect_define',href:' <c:out value='${pageContext.request.contextPath }'/>/home/totalG.htmlx'},
                      ...
                      {id:'p4',title:'订单追踪',height:200,collapsible:true,iconCls:'icon-process',href:' <c:out value='${pageContext.request.contextPath }'/>/home/orderG.htmlx'}/* ,
                      {id:'p4',title:'交易情况',height:300,collapsible:true,iconCls:'icon-chart_bar',href:' <c:out value='${pageContext.request.contextPath }'/>/home/chartG.htmlx'} */
                  ];
