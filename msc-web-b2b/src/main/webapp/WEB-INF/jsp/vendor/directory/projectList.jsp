	...
	$('#dg').datagrid({
		...
		columns:[[
        	...
        	{field:'details',title:'操作',width:10,align:'center',
				formatter: function(value,row,index){
					return "<a href=\"javascript:;\" onclick=\"toExcel('"+row.code+"')\">导出明细</a>";
				}
        	}
   		]],
...
function toExcel(code) {
	window.open(" <c:out value='${pageContext.request.contextPath }'/>/hospital/plan/export.htmlx?projectCode="+code);
}
</script>