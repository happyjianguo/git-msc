		 	...
		 	<tr>
				<th width="15%">证照图片：</th>
		   		<th width="85%" colspan=3>
					...
					<div id="localImag">
						<%--预览，默认图片--%>
						<img id="preview" alt="" src="<c:out value='${pageContext.request.contextPath }'/>/vendor/companyCertReg/readfile.htmlx?fileid=${companyCertReg.imagePath}" style="width: 300px; height: 200px;" />
					</div>
		   		</th>
		   </tr>
		 	<tr>
...
createDate.innerHTML = $.format.date("${companyCertReg.createDate}","yyyy-MM-dd HH:mm:ss");
...
$(function(){
	...
	$('#company').combogrid({
		idField:'id',    
		textField:'fullName',
		value:'${companyCertReg.company.id}',
	...
	$("#form1").form({
		url :" <c:out value='${pageContext.request.contextPath }'/>/vendor/companyCertReg/edit.htmlx",
		onSubmit : function() {
			var auditStatus = form1.auditStatus.value;
			if(auditStatus == "send" || auditStatus == "pass"){
				$.messager.alert("错误","审核过程中的资料不能修改！","info");
				return false;
			}
